...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "spjcexhma1w4xk1jjxzrt84xje4j795zx1zmmex1147e54kev6z0",
  ...
  manifest = (
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "Collaborative Decision-Making"),
    ...
    viewInfo = (
      permissions = [
        (
          ...
          description = (defaultText = "grants ability to administer instance"),
        ),
      ],
      roles = [
        (
          ...
          permissions  = [true],
          verbPhrase = (defaultText = "can administer the instance"),
